...
python scripts/tts.py speak "Hello, this is Machine speaking."
...
```bash
python scripts/tts.py speak "Welcome to the Machine Weekly. I'm your host, and today we're diving into autonomous AI agents." \
